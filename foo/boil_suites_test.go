...
func TestToOne(t *testing.T) {
	...
	t.Run("TagToTagUsingParentTagTag", testTagToOneTagUsingParentTagTag)
}
...
func TestToMany(t *testing.T) {
	...
	t.Run("TagToParentTagTags", testTagToManyParentTagTags)
}
...
func TestToOneSet(t *testing.T) {
	...
	t.Run("TagToTagUsingParentTagTags", testTagToOneSetOpTagUsingParentTagTag)
}
...
func TestToOneRemove(t *testing.T) {
	...
	t.Run("DocumentToDocumentTypeUsingDocuments", testDocumentToOneRemoveOpDocumentTypeUsingDocumentType)
	t.Run("TagToTagUsingParentTagTags", testTagToOneRemoveOpTagUsingParentTagTag)
}
...
func TestToManyAdd(t *testing.T) {
	...
	t.Run("TagToParentTagTags", testTagToManyAddOpParentTagTags)
}
...
func TestToManySet(t *testing.T) {
	...
	t.Run("DocumentTypeToDocuments", testDocumentTypeToManySetOpDocuments)
	...
	t.Run("TagToParentTagTags", testTagToManySetOpParentTagTags)
}
...
func TestToManyRemove(t *testing.T) {
	...
	t.Run("DocumentTypeToDocuments", testDocumentTypeToManyRemoveOpDocuments)
	...
	t.Run("TagToParentTagTags", testTagToManyRemoveOpParentTagTags)
}
