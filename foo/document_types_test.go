...
func testDocumentTypeToManyDocuments(t *testing.T) {
	...
	queries.Assign(&b.DocumentTypeID, a.ID)
	queries.Assign(&c.DocumentTypeID, a.ID)
	...
	for _, v := range check {
		if queries.Equal(v.DocumentTypeID, b.DocumentTypeID) {
			bFound = true
		}
		if queries.Equal(v.DocumentTypeID, c.DocumentTypeID) {
			cFound = true
		}
	}
...
func testDocumentTypeToManyAddOpDocuments(t *testing.T) {
	...
	for i, x := range foreignersSplitByInsertion {
		...
		if !queries.Equal(a.ID, first.DocumentTypeID) {
			t.Error("foreign key was wrong value", a.ID, first.DocumentTypeID)
		}
		if !queries.Equal(a.ID, second.DocumentTypeID) {
...
func testDocumentTypeToManySetOpDocuments(t *testing.T) {
	var err error
	...
	if !queries.IsValuerNil(b.DocumentTypeID) {
		t.Error("want b's foreign key value to be nil")
	}
	if !queries.IsValuerNil(c.DocumentTypeID) {
		t.Error("want c's foreign key value to be nil")
	}
	if !queries.Equal(a.ID, d.DocumentTypeID) {
		t.Error("foreign key was wrong value", a.ID, d.DocumentTypeID)
	}
	if !queries.Equal(a.ID, e.DocumentTypeID) {
		t.Error("foreign key was wrong value", a.ID, e.DocumentTypeID)
	}

	if b.R.DocumentType != nil {
		t.Error("relationship was not removed properly from the foreign struct")
	}
	if c.R.DocumentType != nil {
		t.Error("relationship was not removed properly from the foreign struct")
	}
	if d.R.DocumentType != &a {
		t.Error("relationship was not added properly to the foreign struct")
	}
	if e.R.DocumentType != &a {
		t.Error("relationship was not added properly to the foreign struct")
	}
...
func testDocumentTypeToManyRemoveOpDocuments(t *testing.T) {
	var err error
