...
func testTagToManyBookmarks(t *testing.T) {
	...
	_, err = tx.Exec("insert into \"bookmark_contexts\" (\"tag_id\", \"bookmark_id\") values (?, ?)", a.ID, b.ID)
	if err != nil {
		t.Fatal(err)
	}
	_, err = tx.Exec("insert into \"bookmark_contexts\" (\"tag_id\", \"bookmark_id\") values (?, ?)", a.ID, c.ID)
	if err != nil {
		t.Fatal(err)
	}
...
func testTagToManyDocuments(t *testing.T) {
	...
	_, err = tx.Exec("insert into \"document_contexts\" (\"tag_id\", \"document_id\") values (?, ?)", a.ID, b.ID)
	if err != nil {
		t.Fatal(err)
	}
	_, err = tx.Exec("insert into \"document_contexts\" (\"tag_id\", \"document_id\") values (?, ?)", a.ID, c.ID)
	if err != nil {
		t.Fatal(err)
	}
