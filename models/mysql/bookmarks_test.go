...
var (
	bookmarkDBTypes = map[string]string{`ID`: `int`, `IsRead`: `int`, `Title`: `varchar`, `URL`: `varchar`, `BookmarkTypeID`: `int`, `IsCollection`: `int`, `CreatedAt`: `timestamp`, `UpdatedAt`: `timestamp`, `DeletedAt`: `timestamp`}
	_               = bytes.MinRead
)
