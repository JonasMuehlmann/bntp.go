...
var (
	bookmarkDBTypes = map[string]string{`ID`: `integer`, `IsRead`: `integer`, `Title`: `text`, `URL`: `text`, `TimeAdded`: `timestamp without time zone`, `BookmarkTypeID`: `integer`, `IsCollection`: `integer`}
	_               = bytes.MinRead
)
