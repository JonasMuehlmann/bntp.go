...
func (tagL) LoadBookmarks(ctx context.Context, e boil.ContextExecutor, singular bool, maybeTag interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		qm.Select("\"bookmarks\".\"id\", \"bookmarks\".\"is_read\", \"bookmarks\".\"title\", \"bookmarks\".\"url\", \"bookmarks\".\"time_added\", \"bookmarks\".\"bookmark_type_id\", \"bookmarks\".\"is_collection\", \"a\".\"tag_id\""),
		qm.From("\"bookmarks\""),
...
func (tagL) LoadDocuments(ctx context.Context, e boil.ContextExecutor, singular bool, maybeTag interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		qm.Select("\"documents\".\"id\", \"documents\".\"path\", \"documents\".\"document_type_id\", \"a\".\"tag_id\""),
		qm.From("\"documents\""),
