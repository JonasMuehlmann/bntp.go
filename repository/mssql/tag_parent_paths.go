...
var TagParentPathWhere = struct {
	...
	ID:          whereHelperint{field: "[dbo].[tag_parent_paths].[id]"},
	ParentTagID: whereHelpernull_Int{field: "[dbo].[tag_parent_paths].[parent_tag_id]"},
	ChildTagID:  whereHelpernull_Int{field: "[dbo].[tag_parent_paths].[child_tag_id]"},
	Distance:    whereHelpernull_Int{field: "[dbo].[tag_parent_paths].[distance]"},
}
...
func FindTagParentPath(ctx context.Context, exec boil.ContextExecutor, iD int, selectCols ...string) (*TagParentPath, error) {
	...
	query := fmt.Sprintf(
		"select %s from [dbo].[tag_parent_paths] where [id]=$1", sel,
	)
...
func (o *TagParentPath) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	sql := "DELETE FROM [dbo].[tag_parent_paths] WHERE [id]=$1"
...
func TagParentPathExists(ctx context.Context, exec boil.ContextExecutor, iD int) (bool, error) {
	var exists bool
	sql := "select case when exists(select top(1) 1 from [dbo].[tag_parent_paths] where [id]=$1) then 1 else 0 end"
