...
var (
	...
	tagParentPathColumnsWithoutDefault = []string{"id"}
	tagParentPathColumnsWithDefault    = []string{"parent_tag_id", "child_tag_id", "distance"}
...
func FindTagParentPath(ctx context.Context, exec boil.ContextExecutor, iD int, selectCols ...string) (*TagParentPath, error) {
	...
	query := fmt.Sprintf(
		"select %s from \"tag_parent_paths\" where \"id\"=$1", sel,
	)
...
func (o *TagParentPath) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	...
	if !cached {
		...
		cache.query = buildUpsertQueryPostgres(dialect, "\"tag_parent_paths\"", updateOnConflict, ret, update, conflict, insert)
...
func (o *TagParentPath) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	sql := "DELETE FROM \"tag_parent_paths\" WHERE \"id\"=$1"
...
func TagParentPathExists(ctx context.Context, exec boil.ContextExecutor, iD int) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from \"tag_parent_paths\" where \"id\"=$1 limit 1)"
