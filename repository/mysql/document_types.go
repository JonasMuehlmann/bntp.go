...
var DocumentTypeWhere = struct {
	...
	ID:           whereHelperint{field: "`document_types`.`id`"},
...
func (o *DocumentType) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to populate default values for document_types")
	}
...
func (o *DocumentType) Upsert(ctx context.Context, exec boil.ContextExecutor, updateColumns, insertColumns boil.Columns) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to upsert for document_types")
	}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to retrieve unique values for document_types")
	}
