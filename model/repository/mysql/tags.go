...
func (o *Tag) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	...
	if err != nil {
		return errors.Wrap(err, "repository: unable to populate default values for tags")
	}
...
func (o *Tag) Upsert(ctx context.Context, exec boil.ContextExecutor, updateColumns, insertColumns boil.Columns) error {
	...
	if err != nil {
		return errors.Wrap(err, "repository: unable to upsert for tags")
	}
	...
	if err != nil {
		return errors.Wrap(err, "repository: unable to retrieve unique values for tags")
	}
