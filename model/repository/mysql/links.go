...
var LinkWhere = struct {
	...
	SourceID:      whereHelperint{field: "`links`.`source_id`"},
	DestinationID: whereHelperint{field: "`links`.`destination_id`"},
}
...
func FindLink(ctx context.Context, exec boil.ContextExecutor, sourceID int, destinationID int, selectCols ...string) (*Link, error) {
	linkObj := &Link{}
...
func LinkExists(ctx context.Context, exec boil.ContextExecutor, sourceID int, destinationID int) (bool, error) {
	var exists bool
