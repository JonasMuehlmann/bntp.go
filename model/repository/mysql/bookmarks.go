...
func (o *Bookmark) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	...
	if err != nil {
		return errors.Wrap(err, "repository: unable to populate default values for bookmarks")
	}
...
func (o *Bookmark) Upsert(ctx context.Context, exec boil.ContextExecutor, updateColumns, insertColumns boil.Columns) error {
	...
	if err != nil {
		return errors.Wrap(err, "repository: unable to upsert for bookmarks")
	}
	...
	if err != nil {
		return errors.Wrap(err, "repository: unable to retrieve unique values for bookmarks")
	}
