...
var BookmarkWhere = struct {
	...
	ID:             whereHelperint64{field: "[dbo].[bookmarks].[id]"},
	IsRead:         whereHelperint64{field: "[dbo].[bookmarks].[is_read]"},
	Title:          whereHelpernull_String{field: "[dbo].[bookmarks].[title]"},
	URL:            whereHelperstring{field: "[dbo].[bookmarks].[url]"},
	BookmarkTypeID: whereHelpernull_Int64{field: "[dbo].[bookmarks].[bookmark_type_id]"},
	IsCollection:   whereHelperint64{field: "[dbo].[bookmarks].[is_collection]"},
...
func (r *bookmarkR) GetBookmarkType() *BookmarkType {
	if r == nil {
		return nil
	}
	return r.BookmarkType
}

func (r *bookmarkR) GetTags() TagSlice {
	if r == nil {
		return nil
	}
	return r.Tags
...
maybebookmarkGeneratedColumns      = []string{"id"}
)
...
func (q bookmarkQuery) One(ctx context.Context, exec boil.ContextExecutor) (*Bookmark, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "repository: failed to execute a one query for bookmarks")
	}
...
func (q bookmarkQuery) All(ctx context.Context, exec boil.ContextExecutor) (BookmarkSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "repository: failed to assign all query results to Bookmark slice")
	}
...
func (q bookmarkQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "repository: failed to count bookmarks rows")
	}
...
func (q bookmarkQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "repository: failed to check if bookmarks exists")
	}
...
func (bookmarkL) LoadTags(ctx context.Context, e boil.ContextExecutor, singular bool, maybeBookmark interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		qm.Select("[dbo].[tags].[id], [dbo].[tags].[tag], [dbo].[tags].[parent_tag], [dbo].[tags].[path], [dbo].[tags].[children], [a].[bookmark_id]"),
		qm.From("[dbo].[tags]"),
...
func FindBookmark(ctx context.Context, exec boil.ContextExecutor, iD int64, selectCols ...string) (*Bookmark, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "repository: unable to select from bookmarks")
	}
...
func (o *Bookmark) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("repository: no bookmarks provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "repository: unable to insert into bookmarks")
	}
...
func (o *Bookmark) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("repository: unable to update bookmarks, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "repository: unable to update bookmarks row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "repository: failed to get rows affected by update for bookmarks")
	}
...
func (q bookmarkQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "repository: unable to update all for bookmarks")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "repository: unable to retrieve rows affected for bookmarks")
	}
...
func (o BookmarkSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "repository: unable to update all in bookmark slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "repository: unable to retrieve rows affected all in update all bookmark")
	}
	return rowsAff, nil
}
...
func (o *Bookmark) Upsert(ctx context.Context, exec boil.ContextExecutor, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("repository: no bookmarks provided for upsert")
	}
	...
	if !cached {
		...
		if len(insert) == 0 {
			return errors.New("repository: unable to upsert bookmarks, could not build insert column list")
		}
		...
		if !updateColumns.IsNone() && len(update) == 0 {
			return errors.New("repository: unable to upsert bookmarks, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "repository: unable to upsert bookmarks")
	}
...
func (o *Bookmark) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("repository: no Bookmark provided for delete")
	}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "repository: unable to delete from bookmarks")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "repository: failed to get rows affected by delete for bookmarks")
	}
...
func (q bookmarkQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("repository: no bookmarkQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "repository: unable to delete all from bookmarks")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "repository: failed to get rows affected by deleteall for bookmarks")
	}
...
func (o BookmarkSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "repository: unable to delete all from bookmark slice")
	}
...
func (o *BookmarkSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "repository: unable to reload all in BookmarkSlice")
	}
...
func BookmarkExists(ctx context.Context, exec boil.ContextExecutor, iD int64) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "repository: unable to check if bookmarks exists")
	}
