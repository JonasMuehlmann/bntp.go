...
var DocumentWhere = struct {
	...
	CreatedAt:      whereHelperstring{field: "\"documents\".\"created_at\""},
	UpdatedAt:      whereHelperstring{field: "\"documents\".\"updated_at\""},
	DeletedAt:      whereHelpernull_String{field: "\"documents\".\"deleted_at\""},
}
...
var (
	...
	documentColumnsWithoutDefault = []string{"path", "created_at", "updated_at"}
	documentColumnsWithDefault    = []string{"id", "document_type_id", "deleted_at"}
...
func (o *Document) Tags(mods ...qm.QueryMod) tagQuery {
	...
	queryMods = append(queryMods,
		qm.InnerJoin("\"document_contexts\" on \"tags\".\"id\" = \"document_contexts\".\"tag_id\""),
		qm.Where("\"document_contexts\".\"document_id\"=?", o.ID),
	)
...
func (o *Document) SourceDocuments(mods ...qm.QueryMod) documentQuery {
	...
	queryMods = append(queryMods,
		qm.InnerJoin("\"links\" on \"documents\".\"id\" = \"links\".\"source_id\""),
		qm.Where("\"links\".\"destination_id\"=?", o.ID),
	)
...
func (o *Document) DestinationDocuments(mods ...qm.QueryMod) documentQuery {
	...
	queryMods = append(queryMods,
		qm.InnerJoin("\"links\" on \"documents\".\"id\" = \"links\".\"destination_id\""),
		qm.Where("\"links\".\"source_id\"=?", o.ID),
	)
...
func (documentL) LoadDocumentType(ctx context.Context, e boil.ContextExecutor, singular bool, maybeDocument interface{}, mods queries.Applicator) error {
	...
	if singular {
		...
		if !queries.IsNil(object.DocumentTypeID) {
	...
	Outer:
		for _, obj := range slice {
			...
			for _, a := range args {
				if queries.Equal(a, obj.DocumentTypeID) {
					continue Outer
				}
			}

			if !queries.IsNil(obj.DocumentTypeID) {
	...
	query := NewQuery(
		qm.From(`document_types`),
		qm.WhereIn(`document_types.id in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
	...
	for _, local := range slice {
		for _, foreign := range resultSlice {
			if queries.Equal(local.DocumentTypeID, foreign.ID) {
...
func (documentL) LoadTags(ctx context.Context, e boil.ContextExecutor, singular bool, maybeDocument interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		qm.Select("\"tags\".\"id\", \"tags\".\"tag\", \"tags\".\"parent_tag\", \"tags\".\"path\", \"tags\".\"children\", \"a\".\"document_id\""),
		qm.From("\"tags\""),
		qm.InnerJoin("\"document_contexts\" as \"a\" on \"tags\".\"id\" = \"a\".\"tag_id\""),
...
func (documentL) LoadSourceDocuments(ctx context.Context, e boil.ContextExecutor, singular bool, maybeDocument interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		qm.Select("\"documents\".\"id\", \"documents\".\"path\", \"documents\".\"document_type_id\", \"documents\".\"created_at\", \"documents\".\"updated_at\", \"documents\".\"deleted_at\", \"a\".\"destination_id\""),
		qm.From("\"documents\""),
		qm.InnerJoin("\"links\" as \"a\" on \"documents\".\"id\" = \"a\".\"source_id\""),
...
func (documentL) LoadDestinationDocuments(ctx context.Context, e boil.ContextExecutor, singular bool, maybeDocument interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		qm.Select("\"documents\".\"id\", \"documents\".\"path\", \"documents\".\"document_type_id\", \"documents\".\"created_at\", \"documents\".\"updated_at\", \"documents\".\"deleted_at\", \"a\".\"source_id\""),
		qm.From("\"documents\""),
		qm.InnerJoin("\"links\" as \"a\" on \"documents\".\"id\" = \"a\".\"destination_id\""),
...
func (o *Document) SetDocumentType(ctx context.Context, exec boil.ContextExecutor, insert bool, related *DocumentType) error {
	...
	queries.Assign(&o.DocumentTypeID, related.ID)
	if o.R == nil {
		o.R = &documentR{
...
// RemoveDocumentType relationship.
// Sets o.R.DocumentType to nil.
// Removes o from all passed in related items' relationships struct.
func (o *Document) RemoveDocumentType(ctx context.Context, exec boil.ContextExecutor, related *DocumentType) error {
	var err error

	queries.SetScanner(&o.DocumentTypeID, nil)
	if _, err = o.Update(ctx, exec, boil.Whitelist("document_type_id")); err != nil {
		return errors.Wrap(err, "failed to update local table")
	}

	if o.R != nil {
		o.R.DocumentType = nil
	}
	...
	for i, ri := range related.R.Documents {
		if queries.Equal(o.DocumentTypeID, ri.DocumentTypeID) {
			continue
		}
...
func (o *Document) AddTags(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Tag) error {
	...
	for _, rel := range related {
		query := "insert into \"document_contexts\" (\"document_id\", \"tag_id\") values (?, ?)"
...
func (o *Document) SetTags(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Tag) error {
	query := "delete from \"document_contexts\" where \"document_id\" = ?"
...
func (o *Document) RemoveTags(ctx context.Context, exec boil.ContextExecutor, related ...*Tag) error {
	...
	var err error
	query := fmt.Sprintf(
		"delete from \"document_contexts\" where \"document_id\" = ? and \"tag_id\" in (%s)",
...
func (o *Document) AddSourceDocuments(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Document) error {
	...
	for _, rel := range related {
		query := "insert into \"links\" (\"destination_id\", \"source_id\") values (?, ?)"
		values := []interface{}{o.ID, rel.ID}
...
func (o *Document) SetSourceDocuments(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Document) error {
	query := "delete from \"links\" where \"destination_id\" = ?"
	values := []interface{}{o.ID}
	if boil.IsDebug(ctx) {
		writer := boil.DebugWriterFrom(ctx)
		fmt.Fprintln(writer, query)
...
func (o *Document) RemoveSourceDocuments(ctx context.Context, exec boil.ContextExecutor, related ...*Document) error {
	...
	var err error
	query := fmt.Sprintf(
		"delete from \"links\" where \"destination_id\" = ? and \"source_id\" in (%s)",
		strmangle.Placeholders(dialect.UseIndexPlaceholders, len(related), 2, 1),
	)
	values := []interface{}{o.ID}
	for _, rel := range related {
...
func (o *Document) AddDestinationDocuments(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Document) error {
	...
	for _, rel := range related {
		query := "insert into \"links\" (\"source_id\", \"destination_id\") values (?, ?)"
		values := []interface{}{o.ID, rel.ID}
...
func (o *Document) SetDestinationDocuments(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Document) error {
	query := "delete from \"links\" where \"source_id\" = ?"
	values := []interface{}{o.ID}
	if boil.IsDebug(ctx) {
		writer := boil.DebugWriterFrom(ctx)
		fmt.Fprintln(writer, query)
...
func (o *Document) RemoveDestinationDocuments(ctx context.Context, exec boil.ContextExecutor, related ...*Document) error {
	...
	var err error
	query := fmt.Sprintf(
		"delete from \"links\" where \"source_id\" = ? and \"destination_id\" in (%s)",
		strmangle.Placeholders(dialect.UseIndexPlaceholders, len(related), 2, 1),
	)
	values := []interface{}{o.ID}
	for _, rel := range related {
...
func (o *Document) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	...
	if !cached {
		...
		cache.query = buildUpsertQuerySQLite(dialect, "\"documents\"", updateOnConflict, ret, update, conflict, insert)
	...
	if err != nil {
		return errors.Wrap(err, "repository: unable to upsert documents")
	}
