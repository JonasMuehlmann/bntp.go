...
type Document struct {
	...
	DocumentTypeID int64       `boil:"document_type_id" json:"document_type_id" toml:"document_type_id" yaml:"document_type_id"`
...
var DocumentWhere = struct {
	...
	DocumentTypeID whereHelperint64
	...
	DocumentTypeID: whereHelperint64{field: "\"documents\".\"document_type_id\""},
...
var (
	...
	documentColumnsWithoutDefault = []string{"path", "document_type_id", "created_at", "updated_at"}
	documentColumnsWithDefault    = []string{"id", "deleted_at"}
