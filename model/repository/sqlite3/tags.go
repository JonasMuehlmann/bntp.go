...
var (
	...
	tagColumnsWithoutDefault = []string{"tag", "path", "children"}
	tagColumnsWithDefault    = []string{"id", "parent_tag"}
...
func (o *Tag) SetParentTagTag(ctx context.Context, exec boil.ContextExecutor, insert bool, related *Tag) error {
	...
	updateQuery := fmt.Sprintf(
		...
		strmangle.SetParamNames("\"", "\"", 0, []string{"parent_tag"}),
...
func (o *Tag) SetParentTagTags(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Tag) error {
	query := "update \"tags\" set \"parent_tag\" = null where \"parent_tag\" = ?"
	values := []interface{}{o.ID}
	if boil.IsDebug(ctx) {
		writer := boil.DebugWriterFrom(ctx)
		fmt.Fprintln(writer, query)
