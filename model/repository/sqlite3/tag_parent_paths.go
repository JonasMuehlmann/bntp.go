...
func (q tagParentPathQuery) One(ctx context.Context, exec boil.ContextExecutor) (*TagParentPath, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "repository: failed to execute a one query for tag_parent_paths")
	}
...
func (q tagParentPathQuery) All(ctx context.Context, exec boil.ContextExecutor) (TagParentPathSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "repository: failed to assign all query results to TagParentPath slice")
	}
...
func (q tagParentPathQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "repository: failed to count tag_parent_paths rows")
	}
...
func (q tagParentPathQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "repository: failed to check if tag_parent_paths exists")
	}
...
func FindTagParentPath(ctx context.Context, exec boil.ContextExecutor, tagID int64, parentTagID int64, selectCols ...string) (*TagParentPath, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "repository: unable to select from tag_parent_paths")
	}
...
func (o *TagParentPath) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("repository: no tag_parent_paths provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "repository: unable to insert into tag_parent_paths")
	}
...
func (o *TagParentPath) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("repository: unable to update tag_parent_paths, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "repository: unable to update tag_parent_paths row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "repository: failed to get rows affected by update for tag_parent_paths")
	}
...
func (q tagParentPathQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "repository: unable to update all for tag_parent_paths")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "repository: unable to retrieve rows affected for tag_parent_paths")
	}
...
func (o TagParentPathSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "repository: unable to update all in tagParentPath slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "repository: unable to retrieve rows affected all in update all tagParentPath")
	}
	return rowsAff, nil
}
...
func (o *TagParentPath) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("repository: no tag_parent_paths provided for upsert")
	}
	...
	if !cached {
		...
		if updateOnConflict && len(update) == 0 {
			return errors.New("repository: unable to upsert tag_parent_paths, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "repository: unable to upsert tag_parent_paths")
	}
...
func (o *TagParentPath) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("repository: no TagParentPath provided for delete")
	}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "repository: unable to delete from tag_parent_paths")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "repository: failed to get rows affected by delete for tag_parent_paths")
	}
...
func (q tagParentPathQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("repository: no tagParentPathQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "repository: unable to delete all from tag_parent_paths")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "repository: failed to get rows affected by deleteall for tag_parent_paths")
	}
...
func (o TagParentPathSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "repository: unable to delete all from tagParentPath slice")
	}
...
func (o *TagParentPathSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "repository: unable to reload all in TagParentPathSlice")
	}
...
func TagParentPathExists(ctx context.Context, exec boil.ContextExecutor, tagID int64, parentTagID int64) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "repository: unable to check if tag_parent_paths exists")
	}
